/*
O(n**d * n) dynamic programming approach using recursion.
To keep track of already calculated positions one can use one number instead of
a vector of ccordinates if represent a vector as a D-base number.
